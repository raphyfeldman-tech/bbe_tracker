...
CASE_FULL = {
    ...
    "training": pd.DataFrame([
        {"employee_id": "E1", "training_spend": 300000, "salary_cost_during_training": 0},
        {"employee_id": "E2", "training_spend": 300000, "salary_cost_during_training": 0},
    ]),
...
ALL_CASES = [CASE_FULL, CASE_BREACH, CASE_NO_PAYROLL]
